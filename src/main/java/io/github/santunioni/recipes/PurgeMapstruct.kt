 ...
 * implementation class to match the original interface name and removes "implements" declarations.
 ...
 *
 * Note: This recipe copies default methods, static methods, and static fields from the interface
